...
namespace Bookish.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            await _emailSender.SendEmailAsync(user.Email, "New Order - Bookish",
                $"<p> New Order Has been Placed </p>");

            ModelState.AddModelError(string.Empty, "Order Confirmation email sent. Please check your email.");
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            try
            {
                var message = MessageResource.Create(
                    body: "Order Placed on Bookish. Your Order ID:" + id,
